...
<html xmlns = "http://www.w3.org/1999/xhtml">
	...
	<body onload = "startTime()">
		...
		<div id = "top" class = "container-fluid">
							...
							<div class = "row">
								...
								<div class = "col">
									...
									if(isset($_SESSION['login'])) {
										...
										if($row['avatar'] == NULL) { ?>
									<img class = "float-right rounded-circle hidden-sm-down" src = "../assets/images/noprofile.jpg" width = "100" height = "100" alt = "Avatar">
									<?php } else { ?>
			...
			<div class = "row">
				<div class = "col">
					<div class = "container-fluid transparent" style = "margin-top:50px;margin-bottom:50px;padding-bottom:25px;">
						<div class = "row">
							<div class = "col">
								<h3 style = "text-align:center; padding-bottom:15px; padding-top:15px;">All Post Miles</h3>
							</div>
						</div>
						<div class = "row">
							<div class = "col">
                        		<span class = "text-danger" style = "font-weight:bold"><em>*Control+F to search. It might take a while to search the pdf.</em></span>
								<embed src = "../assets/files/PMALL.pdf" style = "width:100%;min-height:850px;"></embed>
							</div>
						</div>
					</div>
				</div>
