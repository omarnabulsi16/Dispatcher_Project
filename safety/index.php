			...
			<div class = "row">
				<div class = "col">
					<div class = "container transparent" style = "margin-top:50px;margin-bottom:50px;padding-bottom:25px;">
						<div class = "row">
							<div class = "col">
								<h3 style = "text-align:center; padding-bottom:20px; padding-top:20px;">D8 Safety</h3>
							</div>
						</div>
						<div class = "row">
							<div class = "col">
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">Maintenance and Safety Chapters</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_02.pdf">Chapter 2 - Safety Meetings</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_05.pdf">Chapter 5 - Office Worker Safety</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_07.pdf">Chapter 7 - Traffic Control</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_08.pdf">Chapter 8 - Protection of Workers</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_09.pdf">Chapter 9 - First Aid</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_20.pdf">Chapter 20 - Earthquake Preparedness</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/Chap_D5.pdf">Chapter D5 - Spills of Substance on Hwy R/W</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/Safety/SM-Chapter-23.pdf">Chapter 23 - Heat Illness Prevention Program</a></td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">Other Links</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/_SOP/safety/ERG2016.pdf">Emergency Response Guide (ERG)</a></td>
												</tr>
												<tr>
													<td ><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "https://hr.onramp.dot.ca.gov/downloads/hr/files/PIBs/2017/PIB17_09.pdf">Employee Emergency Notification System</a></td>
												</tr>
											</tbody>
										</table>
									</div>
