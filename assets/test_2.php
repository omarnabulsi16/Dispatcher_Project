		...
		<div id = "top" class = "container-fluid">
			...
			<div class = "row">
				<div class = "col">
					...
					<?php
                        $db = createConnection();
						$sql = "SELECT * FROM crewarea ORDER BY crew ASC";
						$result = $db->query($sql);
						if(mysqli_num_rows($result) > 0) {
                        	echo "<table class='table table-sm table-striped table-light' style='font-size:14px;'>
                        	...
                        	while($row = $result->fetch_assoc()) {
                            	echo "	<tr>
                                			<td><a class='text-dark' href='../maps/crewcallout.php?crew=".$row['crew']."'>".$row['crew']."</a></td>
                                            <td>".$row['county']."</td>
                                            <td>".$row['route']."</td>
                                            <td>".$row['postmile']."</td>
                                            <td>".$row['topostmile']."</td>
