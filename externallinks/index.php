			...
			<div class = "row">
				<div class = "col">
					<div class = "container transparent" style = "margin-top:50px;margin-bottom:50px;padding-bottom:25px;">
						<div class = "row">
							<div class = "col">
								<h1 style = "text-align:center; padding-bottom:20px; padding-top:20px;">External Links</h1>
							</div>
						</div>
						<div class = "row">
							<div class = "col">
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-dark table-striped">
											<thead>
												<tr>
													<th class = "text-center" colspan = "2">External Links</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td width = "50%"><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://www.dot.ca.gov/">Caltrans Home</a></td>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://onramp.dot.ca.gov/">Onramp</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://www.dot.ca.gov/hq/traffops/engineering/">Cal Nexus (CA Numbered Exits)</a></td>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://pems.dot.ca.gov/">PeMS</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "https://www.ctpass.dot.ca.gov/idm/portal/cn/DefaultContainerPage/WebApplications">CT Pass</a></td>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://hqmaintgis.maps.arcgis.com/apps/Viewer/index.html?appid=c0a381e273564b72a1813dd7822561fb">Rest Area Reference</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://cad.chp.ca.gov/">CHP Media CAD</a></td>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://forecast.weather.gov/MapClick.php?CityName=Fresno&state=CA&site=HNX&textField1=36.7478&textField2=-119.771&e=1">National Weather Service</a</td>
												</tr>
											</tbody>
										</table>
									</div>
