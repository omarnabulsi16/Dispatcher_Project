			...
			<div class = "row">
				<div class = "col">
					<div class = "container transparent" style = "margin-top:50px;margin-bottom:50px;padding-bottom:25px;">
						<div class = "row">
							<div class = "col">
								<h3 style = "text-align:center; padding-bottom:20px; padding-top:20px;">D8 Guidelines | References</h3>
							</div>
						</div>
						<div class = "row">
							<div class = "col">
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center" >CMS | HAR</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://www.dot.ca.gov/trafficops/tm/docs/CMS_Guidelines.pdf">CMS 2013 Guidelines</a></td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">Hazmat</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://webwiser.nlm.nih.gov/getHomeData.do;jsessionid=D853A29F27D2568EA0BB4598AAB08BE8">WISER</a></td>
												</tr>
											</tbody>
										</table>
									</div>
								...
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">Manuals</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/guidelines/ChainControlManual.pdf">Chain Control</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http:\\northregion.dot.ca.gov/rtmc/guidelines/TMCAL_943Manual.pdf">TMCAL 9.4.3 User Manual</a></td>
												</tr>
                    							<?php if(isset($_SESSION['login'])) {
													$temp = checkPriv( createConnection());
													if($temp == "dispatcher" || $temp == "admin") { ?>
                                                <tr>
                                                	<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "../assets/files/Interstate 015 closure plan final signed.pdf">Interstate 015 Closure Plan</a></td>
                                                </tr>
                                                <?php }
												} ?>
											</tbody>
								...
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">Roadway Sign Charts</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/allied/road_signs/2014TEMPORARY.pdf">Roadway Signs - Construction</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/allied/road_signs/2014GUIDE.pdf">Roadway Signs - Guide</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/allied/road_signs/2014REGULATORY.pdf">Roadway Signs - Regulatory</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://northregion.dot.ca.gov/rtmc/allied/road_signs/2014WARNING.pdf">Roadway Signs - Warning</a></td>
												</tr>
											</tbody>
										</table>
									</div>
