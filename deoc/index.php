			...
			<div class = "row">
				<div class = "col">
					<div class = "container transparent" style = "margin-top:50px;margin-bottom:50px;padding-bottom:25px;">
						<div class = "row">
							<div class = "col">
								<h1 style = "text-align:center; padding-bottom:20px; padding-top:20px;">D8 EOC</h1>
							</div>
						</div>
						<div class = "row">
							<div class = "col">
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-dark table-striped">
											<thead>
												<tr>
													<th class = "text-center">District 8 Emergency Operations Center (EOC)</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "../assets/files/districtcoords.pdf">Statewide-District Emergency Coordinators</a></td>
												</tr>
											</tbody>
										</table>
									</div>
