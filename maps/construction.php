			...
			<div class = "row">
				<div class = "col">
					<div class = "container transparent" style = "margin-top:50px;margin-bottom:50px;padding-bottom:25px;">
						<div class = "row">
							<div class = "col">
								<h3 style = "text-align:center; padding-top:15px; padding-bottom:15px;">District Construction</h3>
							</div>
						</div>
						<div class = "row">
							<div class = "col">
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">D8 Construction</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "https://district8.onramp.dot.ca.gov/node/508">D8 Construction Division (Intranet)</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://sv08web/Construction/_State_Template_V4/Docs/MISC/Lists_OrgCharts/Const-PhoneList.pdf">Construction Division Phone List</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://sv08web/Construction/_State_Template_V4/Docs/MISC/Lists_OrgCharts/Field-Offices.pdf">Engineer Areas/Field Offices</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://sv08web/Construction/_State_Template_V4/Electrical.shtml">Electrical Construction (SBD/RIV) (Intranet)</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://sv08web/Construction/_State_Template_V4/Safety.shtml">Safety Officers (Intranet)</a></td>
												</tr>
                    							<tr>
                    								<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "http://sv08web/const2/OGP/index.shtml">D8 Construction On-Going Projects</a></td>
                    							</tr>
											</tbody>
										</table>
									</div>
								...
								<div class = "row">
									<div class = "col">
										<table class = "table table-bordered table-striped table-dark">
											<thead>
												<tr>
													<th class = "text-center">Encroachment Permits</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "https://district8.onramp.dot.ca.gov/node/576">San Bernardino</a></td>
												</tr>
												<tr>
													<td><a class = "btn" role = "button" style = "width:100%;" target = "_blank" href = "https://district8.onramp.dot.ca.gov/node/570">Riverside County</a></td>
												</tr>
											</tbody>
										</table>
									</div>
